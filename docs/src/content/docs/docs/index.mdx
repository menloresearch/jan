...
- Download popular open-source LLMs (Llama3, Gemma3, Qwen3, and more) from the HuggingFace [Model Hub](./manage-models.mdx)
or import any GGUF files (the model format used by llama.cpp) available locally
- Connect to [cloud services](/remote-models/openai) (OpenAI, Anthropic, Mistral, Groq, etc.)
- [Chat](./threads.mdx) with AI models & [customize their parameters](./model-parameters.mdx) via our
intuitive interface
...
- Truly open source via the [Apache 2.0 license](https://github.com/janhq/jan/blob/dev/LICENSE)
...
<details>
<summary>How do I get started with Jan?</summary>
Download Jan on your computer, download a model or add API key for a cloud-based one, and start chatting. For detailed setup instructions, see our [Quick Start](/quickstart) guide.
</details>
...
- [Mac](/desktop/mac#compatibility)
- [Windows](/desktop/windows#compatibility)
- [Linux](/desktop/linux)
...
<details>
<summary>How does Jan protect my privacy?</summary>
...
- Storing all files and chat history on your device in the [Jan Data Folder](/data-folder)
...
You can optionally share anonymous usage statistics to help improve Jan, but your conversations are never shared. See our complete [Privacy Policy](./privacy).
</details>

<details>
<summary>What models can I use with Jan?</summary>
- Download optimized models from the [Jan Hub](/manage-models#1-download-from-jan-hub-recommended)
...
<details>
<summary>Is Jan really free? What's the catch?</summary>
...
Yes! We fully support the self-hosted movement. Either download Jan directly or fork it on [GitHub repository](https://github.com/janhq/jan) and build it from source.
</details>

<details>
<summary>What does Jan stand for?</summary>
