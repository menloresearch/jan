...
import { processFiles, processClipboardImages, type SupportedFileType } from '@/utils/fileUtils'
...
const ChatInput = ({
  ...
  const handleSendMesage = (prompt: string) => {
    ...
    sendMessage(prompt, uploadedFiles.length > 0 ? uploadedFiles : undefined)
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      setMessage(error instanceof Error ? error.message : 'Failed to process files')
    } finally {
  ...
  const handlePaste = async (e: React.ClipboardEvent<HTMLTextAreaElement>) => {
    ...
    try {
      ...
      setMessage(error instanceof Error ? error.message : 'Failed to process pasted images')
    }
  }
    ...
    <div className="relative">
      <div className="relative">
        ...
        >
          ...
          >
            <FileDisplay files={uploadedFiles} onRemoveFile={handleRemoveFile} />
            <TextareaAutosize
              ref={textareaRef}
